    ...
    <div class="k8s-container">
      <el-tabs v-model="activeName">
        <el-tab-pane label="K8S" name="k8s">
          <el-select v-model="docker" @change="getContainerName" placeholder="请选择NameSpace" style="width: 280px" :popper-append-to-body="false">
          ...
          <el-select v-model="docker" @change="getContainerName" placeholder="请选择POD" style="width: 280px" :popper-append-to-body="false">
            <el-option v-for="item in dockers" :key="item.containerId" :label="`${currentUser}@${item.containerName}(${item.containerId})`" :value="item.containerId"></el-option>
          </el-select>
